...
export default function AlexAiUniversalPage() {
  return (
    <div className="flex-1 flex flex-col p-6 h-full">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white">Alex AI Universal</h1>
          <p className="text-gray-400">Advanced orchestration and reasoning engine</p>
        </div>
        <a 
