// File: domains/shared/project-management/src/types/sprint.ts

/**
 * Sprint System TypeScript Interfaces
 *
 * Type definitions for the Agile Sprint Management System
 * Canonical source: apps/unified-dashboard/types/sprint.ts
 * Merged with secondary definitions from product-factory and alex-ai-universal
 */
...
export type StoryStatus =
  ...
  | 'todo' // Not started (alias)
  | 'review' // In review (alias)
