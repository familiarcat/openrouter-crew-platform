import { ProjectWorkbenchModel, WorkbenchAction, WorkbenchStageCard } from './types';
...
function renderAction(action: WorkbenchAction): string {
...
function renderStageCard(card: WorkbenchStageCard): string {
  return `
...
export function renderProjectWorkbenchHtml(model: ProjectWorkbenchModel): string {
