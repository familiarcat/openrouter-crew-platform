...
exports.createProjectWorkbenchModel = createProjectWorkbenchModel;
...
function buildHeroActions(surface) {
...
function createProjectWorkbenchModel(options) {
    ...
    return {
        ...
        subtitle: 'Use the same creation, planning, and operating lanes across the web dashboard and VS Code so project work feels consistent everywhere.',
