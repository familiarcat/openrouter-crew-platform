...
export class ModelRouter {
    ...
    route(request) {
        ...
        if (request.maxCost) {
            candidates = candidates.filter(model => {
                const estimatedCost = this.estimateCost(model, request.estimatedInputTokens, request.estimatedOutputTokens);
     ...
     */
    compareCosts(modelA, modelB, inputTokens, outputTokens) {
